...
class ClientCleaningPlanListItem(BaseModel):
    ...
    repeat_shift: Optional[str] = Field(default=None, description="Display-only free text — never used to determine recurrence; working_days is the only field that does that.", json_schema_extra={"example": None})
